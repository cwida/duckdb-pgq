...
ifeq (${BUILD_SQLPGQ}, 1)
	EXTENSIONS:=${EXTENSIONS} -DBUILD_SQLPGQ_EXTENSION=1
endif
...
ifeq (${BUILD_PYTHON}, 1)
	EXTENSIONS:=${EXTENSIONS} -DBUILD_PYTHON=1 -DBUILD_JSON_EXTENSION=1 -DBUILD_FTS_EXTENSION=1 -DBUILD_TPCH_EXTENSION=1 -DBUILD_VISUALIZER_EXTENSION=1 -DBUILD_TPCDS_EXTENSION=1 -DBUILD_SQLPGQ_EXTENSION=1
endif
