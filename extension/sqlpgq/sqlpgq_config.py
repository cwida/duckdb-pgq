...
source_files = [os.path.sep.join(x.split('/')) for x in
                ['extension/sqlpgq/sqlpgq-extension.cpp', 'extension/sqlpgq/sqlpgq_common.cpp', 'extension/sqlpgq/sqlpgq_functions/sqlpgq_cheapest_path_length.cpp',
                 ...
                 'extension/sqlpgq/sqlpgq_functions/iterativepath.cpp']]
