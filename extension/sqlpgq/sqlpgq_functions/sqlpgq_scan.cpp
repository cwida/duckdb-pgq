...
static void ScanCSREFunction(ClientContext &context, TableFunctionInput &data_p, DataChunk &output) {
	...
	auto csrID = ((CSRScanEData *)(data_p.bind_data))->csrID;
        CSR *csr = sqlpgq_state -> GetCSR(csrID);
...
static void ScanCSRVFunction(ClientContext &context, TableFunctionInput &data_p, DataChunk &output) {
        ...
        auto csrID = ((CSRScanVData *)(data_p.bind_data))->csrID;
        CSR *csr = sqlpgq_state -> GetCSR(csrID);
...
static void ScanCSRWFunction(ClientContext &context, TableFunctionInput &data_p, DataChunk &output) {
        ...
        auto csrID = ((CSRScanWData *)(data_p.bind_data))->csrID;
        CSR *csr = sqlpgq_state -> GetCSR(csrID);
	output.data[0].SetVectorType(VectorType::FLAT_VECTOR);
...
CreateTableFunctionInfo SQLPGQFunctions::GetScanCSREFunction() {
	...
	function_set.AddFunction(TableFunction({LogicalType::INTEGER}, ScanCSREFunction, CSRScanEData::ScanCSREBind, CSRScanState::Init));
...
CreateTableFunctionInfo SQLPGQFunctions::GetScanCSRVFunction() {
        ...
        function_set.AddFunction(TableFunction({LogicalType::INTEGER}, ScanCSRVFunction, CSRScanVData::ScanCSRVBind, CSRScanState::Init));
        return CreateTableFunctionInfo(function_set);
}
...
CreateTableFunctionInfo SQLPGQFunctions::GetScanCSRWFunction() {
        ...
        function_set.AddFunction(TableFunction({LogicalType::INTEGER}, ScanCSRWFunction, CSRScanWData::ScanCSRWBind, CSRScanState::Init));
        return CreateTableFunctionInfo(function_set);
}
...
CreateTableFunctionInfo SQLPGQFunctions::GetScanPGVTableFunction() {
        ...
        function_set.AddFunction(TableFunction({LogicalType::VARCHAR}, ScanPGVTableFunction, PGScanVTableData::ScanPGVTableBind, CSRScanState::Init));
        return CreateTableFunctionInfo(function_set);
}
...
CreateTableFunctionInfo SQLPGQFunctions::GetScanPGVColFunction() {
        ...
        function_set.AddFunction(TableFunction({LogicalType::VARCHAR, LogicalType::VARCHAR}, ScanPGVColFunction, PGScanVColData::ScanPGVColBind, CSRScanState::Init));
        return CreateTableFunctionInfo(function_set);
}
...
CreateTableFunctionInfo SQLPGQFunctions::GetScanPGETableFunction() {
        ...
        function_set.AddFunction(TableFunction({LogicalType::VARCHAR}, ScanPGETableFunction, PGScanETableData::ScanPGETableBind, CSRScanState::Init));
        return CreateTableFunctionInfo(function_set);
}
...
CreateTableFunctionInfo SQLPGQFunctions::GetScanPGEColFunction() {
        ...
        function_set.AddFunction(TableFunction({LogicalType::VARCHAR, LogicalType::VARCHAR}, ScanPGEColFunction, PGScanEColData::ScanPGEColBind, CSRScanState::Init));
        return CreateTableFunctionInfo(function_set);
}
