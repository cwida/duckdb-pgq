...
static void IterativeLengthLaneReuseFunction(DataChunk &args, ExpressionState &state, Vector &result) {
...
CreateScalarFunctionInfo SQLPGQFunctions::GetIterativeLengthLaneReuseFunction() {
	auto fun = ScalarFunction(
	    "iterativelengthlanereuse", {LogicalType::INTEGER, LogicalType::BIGINT, LogicalType::BIGINT, LogicalType::BIGINT},
	    LogicalType::BIGINT, IterativeLengthLaneReuseFunction, IterativeLengthFunctionData::IterativeLengthBind);
