...
PG_KEYWORD("acyclic", ACYCLIC, UNRESERVED_KEYWORD)
...
PG_KEYWORD("are", ARE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("destination", DESTINATION, UNRESERVED_KEYWORD)
...
PG_KEYWORD("edge", EDGE, UNRESERVED_KEYWORD)
PG_KEYWORD("element_id", ELEMENT_ID, UNRESERVED_KEYWORD)
...
PG_KEYWORD("paths", PATHS, UNRESERVED_KEYWORD)
...
PG_KEYWORD("properties", PROPERTIES, UNRESERVED_KEYWORD)
...
PG_KEYWORD("relationship", RELATIONSHIP, UNRESERVED_KEYWORD)
...
PG_KEYWORD("shortest", SHORTEST, UNRESERVED_KEYWORD)
...
PG_KEYWORD("source", SOURCE, UNRESERVED_KEYWORD)
...
PG_KEYWORD("trail", TRAIL, UNRESERVED_KEYWORD)
...
PG_KEYWORD("vertex", VERTEX, UNRESERVED_KEYWORD)
PG_KEYWORD("view", VIEW, UNRESERVED_KEYWORD)
PG_KEYWORD("views", VIEWS, UNRESERVED_KEYWORD)
PG_KEYWORD("virtual", VIRTUAL, UNRESERVED_KEYWORD)
PG_KEYWORD("volatile", VOLATILE, UNRESERVED_KEYWORD)
PG_KEYWORD("walk", WALK, UNRESERVED_KEYWORD)
